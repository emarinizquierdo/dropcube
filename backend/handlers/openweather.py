...
def get_weather(latitude, longitude):
    ...
    WEATHER_API_KEY = Property.get_by_id('weather_api_key').value

    http = urllib3.PoolManager()
    r = http.request('GET', 'https://api.openweathermap.org/data/2.5/onecall?units=metric&exclude=minutely,daily,current&lat={}&lon={}&appid={}'.format(
